...
# Dataset: cohere-msmarco-1024 (1024-dim, cosinesimil) @ 1M vectors
...
echo "=========================================="
echo "Complete Batch Test - 1M Vectors"
echo "=========================================="
echo "API URL: $API_URL"
echo ""
echo "Test Flow:"
echo "  1. Create index"
echo "  2. Bulk ingest 1M vectors"
...
echo "  - 1 sweep for bulk-ingest-1m"
