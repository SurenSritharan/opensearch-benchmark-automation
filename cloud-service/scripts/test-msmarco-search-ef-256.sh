...
echo "  5. Search with k=100, ef=256 (5 client sweeps)"
echo "  6. Search with k=10, ef=256 (5 client sweeps)"
echo ""
...
echo "  - 5 sweeps for search-k100-ef256 (clients: 4,8,10,12,16)"
echo "  - 5 sweeps for search-k10-ef256 (clients: 4,8,10,12,16)"
