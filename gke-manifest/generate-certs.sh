...
DNS.8 = opensearch-cluster.os-jvector-acl.svc.cluster.local
DNS.9 = opensearch-cluster.os-faiss.svc.cluster.local
DNS.10 = opensearch-cluster.os-lucene.svc.cluster.local
DNS.11 = opensearch-cluster.os-develop-jvector.svc.cluster.local
IP.1 = 127.0.0.1
EOF
