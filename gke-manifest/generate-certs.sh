...
DNS.7 = opensearch-cluster.os-develop-jvector.svc.cluster.local
DNS.8 = opensearch-cluster.os-develop-faiss.svc.cluster.local
DNS.9 = opensearch-cluster.os-develop-lucene.svc.cluster.local
IP.1 = 127.0.0.1
EOF
